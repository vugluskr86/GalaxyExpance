...
draw_planet:
  ...
  PUSH_A
  POP_A
  LOAD_A Planet III / Rocky-Temperate
  PUSH_A
  POP_A
  CALL _sys_tty_write
  POP_B
  ...
  PUSH_A
  POP_A
  LOAD_A Survey: 42%  Atmosphere: N2+O2
  PUSH_A
  POP_A
  CALL _sys_tty_write
  POP_B
  ...
  PUSH_A
  POP_A
  LOAD_A Temp: -12..+18C  Press: 0.8atm
  PUSH_A
  POP_A
  CALL _sys_tty_write
  POP_B
  ...
  PUSH_A
  POP_A
  LOAD_A Minerals: Fe/Ni/Quartz  Life: ?
  PUSH_A
  POP_A
  CALL _sys_tty_write
  POP_B
  ...
  PUSH_A
  POP_A
  LOAD_A PROBE: Survey Mk1  Int:100% Bat:87%
  PUSH_A
  POP_A
  CALL _sys_tty_write
  POP_B
  ...
  PUSH_A
  POP_A
  LOAD_A Link: Stable  Cache: 18/64 GB
  PUSH_A
  POP_A
  CALL _sys_tty_write
  POP_B
